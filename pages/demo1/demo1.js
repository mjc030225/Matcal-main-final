...
Page({
  ...
  multplyMatYes(){
    ...
    // var value=newvalue.data.result;
  ...
  MatsAddYes(){
    ...
    var name="("+num1+'x'+Mat1.name+num2+'x'+Mat2.name+")";
    var value1=Mat1.value;
    var value2=Mat2.value;
    var y1=value1.length;
    var y2=value2.length;
  ...
  postdata(data){
    ...
    wx.request({
      ...
      { if(res.statusCode==200)
        {console.log('成功完成数据交互');
        console.log(res.data.result);
        var result=res.data.result;
        var value=res.data.fraction_result
        that.setData(
          {
            tempTxt:result,
            tempValue:value,
